...
set rc [catch {
  ...
  open_checkpoint {C:/Users/Schifman Ben/Documents/UofA/Senior 2016-2017/Fall 2016/574 ECE/ECE574/Assignments/Assignment1/Assignment1/Assignment1.runs/netlists/ADD.dcp}
...
set rc [catch {
  ...
  report_drc -file ADD_drc_opted.rpt
...
set rc [catch {
  ...
  report_io -file ADD_io_placed.rpt
  report_utilization -file ADD_utilization_placed.rpt -pb ADD_utilization_placed.pb
  report_control_sets -verbose -file ADD_control_sets_placed.rpt
...
set rc [catch {
  ...
  report_drc -file ADD_drc_routed.rpt -pb ADD_drc_routed.pb
  report_timing_summary -warn_on_violation -max_paths 10 -file ADD_timing_summary_routed.rpt -rpx ADD_timing_summary_routed.rpx
  report_power -file ADD_power_routed.rpt -pb ADD_power_summary_routed.pb -rpx ADD_power_routed.rpx
  report_route_status -file ADD_route_status.rpt -pb ADD_route_status.pb
  report_clock_utilization -file ADD_clock_utilization_routed.rpt
