...
read_verilog -library xil_defaultlib {
  ...
  {C:/Users/Schifman Ben/Documents/UofA/Senior 2016-2017/Fall 2016/574 ECE/ECE574/Assignments/Assignment1/Assignment1/Assignment1.srcs/sources_1/new/Netlist2.v}
}
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top Netlist2 -part xc7a100tcsg324-1


write_checkpoint -force -noxdef Netlist2.dcp

catch { report_utilization -file Netlist2_utilization_synth.rpt -pb Netlist2_utilization_synth.pb }
